  ...
  return (
    <div className="container py-8 md:py-12">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">Kelola progress belajar Qur'an Anda</p>
      </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border-l-4 border-secondary">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-4xl font-bold text-secondary mt-2">{stats.totalBookmarks}</p>
                </div>
